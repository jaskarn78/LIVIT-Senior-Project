...
<div class="container"> 
  ...
  <!-- /.container-fluid --> 
   ...
   <a href="">
    <h4 class="logo"><img id="imageLogo" src="http://athena.ecs.csus.edu/~teamone/images/LivitLogo.jpg" style="float:left; height:44px; width:44px;" /></h4>
  </a>
    <nav>
  ...
  <!-- Hero Section -->
  <section class="hero" id="hero" style="padding:0px; margin:0px; top:-10px;">
...
<div id="carousel1" class="carousel slide" data-ride="carousel" style="margin-top: 0px; top:0px; padding-top:0px;">
     ...
     <div class="carousel-inner" role="listbox" style="margin:0px padding-top: 0px; top:0px;  height: auto;">
       <div class="item active" style="margin: 0px; padding: 0px; height: auto;"><img src="http://athena.ecs.csus.edu/~teamone/images/citylights.jpg" alt="First slide image" class="center-block img-responsive" style="margin: 0; top: 0px; width:100%; height:auto;">
         <div class="carousel-caption" style="display: none;">
<!--           <h3>First slide Heading</h3>
           <p>First slide Caption</p>-->
         </div>
       </div>
       <div class="item"><img src="http://athena.ecs.csus.edu/~teamone/images/raidas.jpg" alt="Second slide image" class="center-block" style="margin:0px; padding:0px; width:100%; height:auto;">
       ...
       <div class="item" style="margin:0px; padding: 0px;"><img src="http://athena.ecs.csus.edu/~teamone/images/gonFishin.jpg" alt="Third slide image" class="center-block" style="margin: 0px; top:-8px; padding:0px; width:100%; height:auto;">
         <div class="carousel-caption">
          <!--
  ...
  <!-- Hero Section -->
  <section class="liv">
    <a href="../Manage/main_event.php"><button class = "button">CREATE EVENT</button></a>
	<?php
	  if ($_SESSION['privelege_id']==0) {
		echo '<a href="../Manage/admin_headliner.php"><button class = "button">MANAGE EVENTS</button></a>';
	  } else if ($_SESSION['privelege_id']==1) {
		echo '<a href="../Manage/headliner.php"><button class = "button">MANAGE EVENTS</button></a>';
	  }
	?>
  </section>  
  <footer>
