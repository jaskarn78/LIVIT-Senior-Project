<?php
	...
	if ($_SESSION['privelege_id'] != 1 && $_SESSION['privelege_id'] != 0) {
...
<script>
	...
	function showList()
	{
		...
		var url = "http://athena.ecs.csus.edu/~teamone/Manage/php/all_created_events.php?";
...
<nav>
	<ul>
  	...
  	<div class="manageHero" style="margin-top:0px;">
    <div class="listhead" style="margin-top:0px;">    	
	<nav2 id="nav2" class="nav2">
    <ul>
		<form id="eventHeaderForm" name="eventHeaderForm">
			<li><label name="userName" style="color: #fab9ff;" id="userName" ><?php echo $name; ?></label></li>
			<li><label name="eventName" style="width:auto; color: #fab9ff; " id="eventName">Event Name:</label></li>
			<li><input name="searchEventName" id="searchEventName" style="width:auto; background-color: #fab9ff; border-color: #fab9ff;" type="text" onkeyup="setEventName(this.value)"></input></li>
			<li><label name="date" id="date" style="width:auto; color: #fab9ff; ">Date:</label></li>
			<li><input name="searchEventDate" id="searchEventDate" type="text" style="width:auto; background-color: #fab9ff; border-color: #fab9ff;" onkeyup="setEventDate(this.value)"></input></li>
			<li><label name="sponsor" id="sponsor" style="visibility:hidden; width:auto; color: #fab9ff; ">Sponsor:</label></li>
			<li><input name="searchEventSponsor" id ="searchEventSponsor" style=" visibility:hidden; width:auto; background-color: #fab9ff; border-color: #fab9ff;" type="text" onkeyup="setEventSponsor(this.value)"></input></li>
			
			<li><button style="width:auto; padding-left:inherit; padding-right:inherit; height:90%; color: #fab9ff; background-color: #222222; border-color:#fab9ff;" id="removeSelected" type="button" onclick="deleteConfirm()" name="removeSelected">Remove Selected</button></li>
        </form>
 	</ul>
	</nav2>
	</div><!-- end list head-->
