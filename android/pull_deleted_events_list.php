<?php
	...
	$query= "SELECT g.*,event_sponsor,event_description,event_cost,lat,lng,start_date, start_time, preference_name 
	FROM get_all_deleted_event_info as g, events as e 
